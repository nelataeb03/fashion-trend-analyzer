...
def save_to_json(file_names, latent_spaces_pca, file_path='data/latent_spaces.json'):
    """
    This function takes in a list of filenames and the corresponding PCA-transformed latent spaces, 
    and saves them to a JSON file.
    """
    data = {'path': file_names, 'latent_space': latent_spaces_pca.tolist()}
...
def main():
    ...
    save_to_json(file_names, latent_spaces_pca)
