...
def main():
    ...
    dataset = DeepFashionDataset(img_dir, category_file, attribute_file, transform=transform)
    ...
    for epoch in range(num_epochs):
        ...
        for images, category_labels, attribute_labels in data_loader:
            ...
            attribute_loss = criterion_attribute(attribute_output, attribute_labels.float())
